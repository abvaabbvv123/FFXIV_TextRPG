...
vector<MonsterData> MonsterList() {
	vector<MonsterData> monsters = {
		//Chapter 1
		{1, MonsterType::Ladybug, "Little Ladybug", 18, 0, 0, 1,  {0, 1, 4},     6, 6, 6 ,6, 6, 6,  20, 1, 0,	100, 10, 701001, 1, Normal_Melee},
		{2, MonsterType::Spirits, "Water Spirits",  22, 2, 0, 1,  {0, 1, 3},     6, 6, 6 ,8, 6, 6,  20, 1, 1,	100, 10, 1, 1, Normal_Ranged}
	};
	return monsters;
}
